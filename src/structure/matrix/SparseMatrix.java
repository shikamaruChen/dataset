...
public class SparseMatrix implements Iterable<MatrixEntry>, Serializable {
	...
	public static void reshape(SparseMatrix mat) {
		...
		// write back to the given matrix, note that here mat is just a
		// reference copy of the original matrix
	...
	/**
	 * @return a new matrix with shape (rows, cols) with data from the current
	 *         matrix
	 */
